...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$720000$24QAHdIsY61TYcbEK5Y2MW$T3iHK+1DIAELjgYR1wgQSaTZMRUyYI92A+RLp3oIWHw=','2025-10-17 06:28:46.988571',1,'cdln','','','cdln@gmail.com',1,1,'2025-03-25 10:34:10.162063'),(2,'pbkdf2_sha256$720000$4p0GUuAFXZlKYrqiVgGQQ0$StYdB2oyoI4GzWZj3mIsOTWAh3I/UBP0wzDpof1kKLQ=','2025-10-02 12:08:00.196406',1,'admin','','','nepomucenoluis53@gmail.com',1,1,'2025-10-01 09:19:34.009356'),(3,'pbkdf2_sha256$720000$vD8sH8BE5KrpUVoAZWKiBh$5uegZbA4P/f4IsozlQsF7MkrgxTCtZgcRtinJvrCa7M=','2025-10-02 08:35:31.279713',0,'moderator','','','',1,1,'2025-10-01 09:19:34.974307');
...
INSERT INTO `authapp_certificatelog` VALUES (387,'Proof Of Residency','Proof of Residency','2025-10-02 09:17:50.022331','Rafael Rod Jalmasco',2,2211,'BRGY570-2025-000001'),(388,'Good Moral','Good Moral Certificate','2025-10-17 06:32:08.257913','Rafael Rod Jalmasco',1,2211,'BRGY570-2025-000002');
...
CREATE TABLE `authapp_personinformation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2213 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `authapp_personinformation` VALUES (2211,'NCR','BF Homes','Jalmasco','Rafael','Rod','033','Nunez Extension','Paranaque','Zamboanga del Sur','2025-10-02','Cavite Silang','Female','Single','none','Filipino','Brother','No Formal Education','PWD','Non-Voter','Inactive'),(2212,'wadwad','dwadwa','dwad','dwa','dwa','323','dwadawdaw','awdadwa','wadaw','2025-10-12','dwadwadaw','Male','Single','dwadwa','dwadwa','dwadaw','No Formal Education','PWD','Non-Voter','Inactive');
...
-- Dump completed on 2025-10-17 15:36:03
